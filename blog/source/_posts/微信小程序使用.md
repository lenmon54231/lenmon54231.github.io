...
```html
  <canvas type="2d" id="offsetCanvas" style="width:{{width}}px;height:{{height}}px" />
```
              ...
              imgObj.onload = () => {
                if (imgObj.complete) {
                  ...
                  if (imageRatio >= screenRatio) {
                    sWidth = (windowWidth * imgObj.height) / windowHeight;
                    sHeight = imgObj.height;
                    sx = (imgObj.width - sWidth) / 2;
                    sy = 0;
                  } else {
                    sWidth = imgObj.width;
                    sHeight = (windowHeight * imgObj.width) / windowWidth;
                    sx = 0;
